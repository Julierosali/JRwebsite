      ...
      <div className="mx-auto max-w-6xl px-4 py-16 md:py-24">
        ...
        {articles.length > 0 && (
          <motion.div
            ...
            className="mb-10"
          >
            <div className={`grid gap-6 ${articles.length === 1 ? 'max-w-lg mx-auto' : 'md:grid-cols-2'}`}>
              {articles.map((article, i) => (
                <motion.a
                  ...
                  className="group relative flex flex-col overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-lg transition hover:border-white/30 hover:bg-white/10 hover:shadow-xl hover:scale-[1.02]"
                >
                  {article.imageUrl ? (
                  ...
                  <div className="flex flex-1 flex-col justify-between p-5">
                    ...
                    <h4 className="font-body text-lg font-semibold leading-snug group-hover:text-violet-light transition">
                      {article.title || 'Article'}
                    </h4>
                    <span className="mt-3 inline-flex items-center gap-1 text-sm text-white/60 group-hover:text-white/90 transition">
              ...
              {radios.map((radio, i) => {
                ...
                return (
                  ...
                  >
                    <Tag
                      {...linkProps}
                      className="group flex flex-col items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-5 text-center transition hover:border-violet/50 hover:bg-white/10 hover:shadow-lg hover:scale-[1.03]"
                    >
                      {radio.logoUrl ? (
                        <div className="relative h-16 w-16 overflow-hidden rounded-full border-2 border-white/20 bg-white/10 transition group-hover:border-violet/60">
                          <Image
                            src={radio.logoUrl}
                        ...
                        <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-white/20 bg-white/10 transition group-hover:border-violet/60">
                      ...
                      <span className="font-title text-sm font-medium leading-tight text-white/90 group-hover:text-white">
                        {radio.name}
                      </span>
                      {radio.url && (
                        <span className="text-xs text-white/40 group-hover:text-violet-light transition">
